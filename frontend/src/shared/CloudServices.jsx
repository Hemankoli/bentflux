    ...
    <div className="max-w-5xl mx-auto py-16 px-4 lg:px-10 ">
      <div className="">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-md font-bold max-w-2xl mx-auto text-secondary">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card */}
          <div className="bg-transperent text-primary rounded-md border-2 border-secondary shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
            <div className="p-6">
